...
global listStd #Making ListStd  Variable
listStd = ["vinay", "surya", "sartaj"] #List Of Students
    

def manageStudent(): # This function is use For The Student Attendance System

	x = "#" * 30
	y = "=" * 28
	global bye #Making Bye  Variable
	bye = "\n {}\n# {} #\n# ===> thanks a lot Skillsync <===  #\n# ===> this is created vinay Pandey <===  #\n# {} #\n {}".format(x, y, y, x) # Will Print GoodBye Message

	#It will Print Welcome Message And options For This Program
	print(""" 

 |======================================================| 
 |======== Welcome To Attendance tracker System	========|
 |======================================================|
  

Enter 1 : To View attendace List 
Enter 2 : To Take attendance Student 
...
Enter 4 : To Remove Student 
	...
	if(userInput == 1): #This Option Will Print Attendance List Of Students
		print("List Students\n")  
		for students in listStd:
			print("=> {}".format(students))

	elif(userInput == 2): #This Option Will take attendance 
		newStd = input("Enter Name Student: ")
		if(newStd in listStd): #This Condition Checking The New Student Is Already In List Ur Not
			...
			print("\n=> Name Student {} Successfully take attendance \n".format(newStd))
			for students in listStd:
				print("=> {}".format(students))	
...
def runAgain(): 
	...
	if(runAgn.lower() == 'y'):
		...
		quit(bye) #Print thanks a lot Skillsync
